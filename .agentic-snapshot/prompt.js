...
import { findGitBashPath, resolveShellPath } from "./common/shell-utils.js";
import { supportsMultimodal } from "./common/model-capabilities.js";
...
export function getDefaultSkillPrompt(options = {}) {
...
export function buildSkillDocumentsPrompt(skills) {
...
function listSkillResourceFiles(skillFilePath, limit) {
...
export function getRuntimeContext(projectRoot, model) {
...
export function getTools(_options = {}, externalTools = []) {
    const tools = [
        {
            type: "function",
            function: {
