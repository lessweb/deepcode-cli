        ...
        return (
          <Box key={item.label} gap={2} flexDirection="row" flexGrow={1}>
            <Box width={labelColumnWidth} flexShrink={0} gap={2}>
              <Text color={actualIndex === activeIndex ? theme.accent : undefined} wrap="truncate-end">
            ...
            <Box flexGrow={1}>
              <Text color={actualIndex === activeIndex ? theme.accent : undefined} wrap="truncate-end" dimColor>
